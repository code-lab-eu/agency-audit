...
async def main():
    ...
    websites = [
        ("https://example-agency1.bg", "Sofia Properties Ltd", 75, "audited", {
            "robots_txt_allows": True, "has_anti_scraping": False, "has_api": True,
            "property_count": 1250, "has_property_map": True,
            "listings_have_price": True, "listings_have_location": True,
            "listings_have_images": True,
            "technology_stack": ["WordPress", "PHP"],
            "response_time_ms": 340, "ssl_valid": True, "language": "bg",
            "listing_quality_score": 0.85,
            "notes": "Standard WordPress real estate plugin",
        }),
        ("https://example-agency2.bg", "Plovdiv Estates", 55, "audited", {
            "robots_txt_allows": True, "has_anti_scraping": False, "has_api": False,
            "property_count": 530, "has_property_map": True,
            "listings_have_price": True, "listings_have_location": True,
            "listings_have_images": True,
            "technology_stack": ["Drupal"],
            "response_time_ms": 450, "ssl_valid": True, "language": "bg",
            "listing_quality_score": 0.7,
            "notes": "Drupal-based site",
        }),
        ("https://example-agency3.bg", "Varna Real Estate", 30, "audited", {
            "robots_txt_allows": True, "has_anti_scraping": False, "has_api": False,
            "property_count": 120, "has_property_map": False,
            "listings_have_price": True, "listings_have_location": True,
            "listings_have_images": False,
            "technology_stack": ["Joomla"],
            "response_time_ms": 800, "ssl_valid": True, "language": "bg",
            "listing_quality_score": 0.5,
            "notes": "Joomla site",
        }),
        ("https://bad-agency.bg", "Blocked Site", -20, "audited", {
            "robots_txt_allows": False, "has_anti_scraping": True, "has_api": False,
            "property_count": 0, "has_property_map": False,
            "listings_have_price": False, "listings_have_location": False,
            "listings_have_images": False,
            "technology_stack": [],
            "response_time_ms": 2000, "ssl_valid": False, "language": "bg",
    ...
    for url, label, score, status, audit_data in websites:
        ...
        if existing:
            await conn.execute(
                ...
                score, status, json.dumps(audit_data), existing,
            )
            wid = existing
        else:
